const uint8_t FreeSans_18Bitmaps[] PROGMEM = {
...
const GFXglyph FreeSans_18Glyphs[] PROGMEM = {
  {     0,   0,   0,   9,    0,    1 },   // 0x20 ' '
  {     0,   3,  26,  12,    4,  -25 },   // 0x21 '!'
  {    10,   9,   9,  12,    1,  -24 },   // 0x22 '"'
...
const GFXfont FreeSans_18 PROGMEM = {
  (uint8_t  *)FreeSans_18Bitmaps,
  (GFXglyph *)FreeSans_18Glyphs,
  0x20, 0x7E, 42 };
